...
<div class="form-group">
                        ...
                        <select name="id-aluno">
                            @foreach ($alunos as $aluno)
                            <option value="{{$aluno->id}}">{{$aluno->nome}} - {{ $aluno->AlunoTurma?->turma?->nome}}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        <label>Projeto</label>
                        <input type="text" class="form-control" name='projeto' placeholder="Digite Aqui">
                    </div>
                    
                    <div class="form-group">
                        <label>Teste</label>
                        <input type="text" class="form-control" name='teste' placeholder="Digite Aqui">
                    </div>

                    <div class="form-group">
                        <label>Prova</label>
                        <input type="text" class="form-control" name='prova' placeholder="Digite Aqui">
                    </div>
